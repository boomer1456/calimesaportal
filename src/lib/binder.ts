...
export const POLICY_FOLDERS: BinderFolder[] = [
  ...
  },
  {
    ...
    href: VOL.v3,
    items: items("Volume 3", VOL.v3, [
      ["301.01", "Safety management system", { page: 3 }],
      ["301.02", "Emergency action plan", { page: 10 }],
      ["301.03", "Fire prevention plan", { page: 35 }],
      ["301.04", "Monthly fire extinguisher inspection", { page: 40 }],
      ["301.06", "Personal injury reporting", { page: 45 }],
      ["301.10", "Personal protective equipment", { page: 50 }],
      ["301.13", "Hazard communication program", { page: 60 }],
      ["301.14", "Lockout, block out, and tagout", { page: 75 }],
      ["301.16", "Respiratory protection", { page: 85 }],
      ["301.17", "Heat illness prevention program", { page: 115 }],
      ["301.18", "Exposure control — bloodborne pathogens", { page: 135 }],
      ["301.20", "Violent acts", { page: 160 }],
      ["302.01", "Code of safe practices", { page: 165 }],
      ["303.01", "Illness and Injury Prevention Program", { page: 180 }],
      ["304.01", "Liability loss control program", { page: 190 }],
      ["305.01", "Return to work from injury or illness", { page: 215 }],
    ]),
  },
  {
    id: "vol5",
